    ...
    <div>
        <div class="container" v-if="status==='loaded'">
            <div class="packageType" v-if="isLoaded">
                <div class="clazz-list"  v-for="(v,k) in packageType" :key="k" @click="openPackage(v)">
                    <div class="clazz">
...
export default {
  ...
  created: async function() {
    ...
    const [resp] = await ajax.all([
      ajax.get(
        "/v1/finalReview/grammarUnitList?bk_id=" +
          params.bk_id
      ),
    ...
    if (resp.data.message === "ok") {
      ...
      vm.paperparams = {
        bk_id: params.bk_id,
        package_type: "REVIEW_VOCAB_GRAMMAR",
        package_name: "词汇语法",
