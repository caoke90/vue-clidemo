  ...
  export default {
    ...
    methods: {
      ...
      feedback() {
        ...
        // 打点
        if (this.$parent && (!!~['lspdetail','lssdetail'].indexOf(this.$parent.bagtype))) { // 听说套卷&听说专项
          sendLog(log.module.m_listenRead,log.op.ls_detail_wrong_click,{s0:'english',s1:this.card.id});
        }
      },
