...
export default {
  ...
  async getBanner() {
    // 单元id bkcId
    const resp=await ajax.post('/v1/assign/questionBankSearchCondition',this.bannerParams);
    // 解构赋值
  ...
  async getcontent(){
    this.setParams();
    return await ajax.post('/v1/assign/getQuestionsFromQuestionBank',this.formatData(this.params));
  },
